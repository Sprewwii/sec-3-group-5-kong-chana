...
+ BaseScammerLists จะมีตัวการ์ดต่างๆ และ ข้างในจะมี meatballs ในการเปิด 3 function edit report delete และ ข้างใน edit จะมี popup ซึ่งเป็นการแก้ไขข้อมูลของผู้โกง
