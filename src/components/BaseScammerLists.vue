...
import Close from "./icons/XIcon.vue"
...
// const scammerLists = scammerLists

defineEmits(['deleteScammer', 'editScammer'])

// สำหรับเปิดปิด meatball dropdown
const selectId = ref(0);
const selectedScammerId = (id) => {
...
// สำหรับเปิด modal Edit
const selectIdToEdit = ref(0)
const selectedScammerIdToEdit = (modalId) => selectIdToEdit.value = modalId

const scammerEdit = ref({})
const editMode = (scammer) => {
    scammerEdit.value = {
        firstName: scammer.firstName,
        lastName: scammer.lastName,
        shopName: scammer.shopName,
        bank: scammer.bank,
        bankId: scammer.bankId,
...
// const editMode = (scammer) => {
//     scammerEdit.value = scammer
//     // console.log(scammerEdit.value)
// }
  ...
  <div>
    <div class="grid gap-7 grid-cols-2 m-20 lg:grid-cols-3 xl:grid-cols-4">
      ...
      >
        ...
        <div class="relative">
          <div
            class="grid absolute inset-0 z-10 bg-black text-center flex flex-col items-center justify-center opacity-0 hover:opacity-100 bg-opacity-80 duration-300 rounded-t-lg hover"
            id="description"
          >
            <h1 class="tracking-wider mt-10 text-xl font-black">
              ประวัติผู้โกง
            </h1>
            <p class="mx-auto break-word mr-7 ml-7 md:text-sm lg:text-base">
              {{ scammer.description }}
            </p>
            <a
              href="#"
              class="flex items-center place-self-end mb-5 mr-5 no-underline hover:underline"
            >
          ...
          <img
            :src="scammer.img"
            alt="scammer"
            class="relative rounded-t-lg w-full"
          />
          <span
        ...
        <div class="card-body ml-10 mr-10 mt-5">
              ...
              >
                <li>
                  ...
                  >
                    ...
                    >
                      <form
                        class="bg-white shadow-md rounded-2xl px-6 pt-6 pb-8 mb-4 w-full"
                      >
                        <div class="pt-3.5">
                          <div class="flex">
                        ...
                        <div class="pt-3">
                          ...
                          <textarea
                            ...
                            v-model="scammerEdit.description"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                          >
                          </textarea>
                        </div>
                        ...
                        <div class="pt-5">
                          <button
                            ...
                            @click="
                              $emit('editScammer', {
                                firstName: scammerEdit.firstName,
                                lastName: scammerEdit.lastName,
                                shopName: scammerEdit.shopName,
                                bank: scammerEdit.bank,
                                bankId: scammerEdit.bankId,
                                description: scammerEdit.description,
                                img: scammerEdit.img,
                                isActive: scammerEdit.isActive,
                                id: scammerEdit.id,
                                count: scammerEdit.count
                              });
                              selectedScammerIdToEdit(0)
                            "
                          >
                            แก้ไขรายชื่อผู้โกง
                          </button>
          ...
          <div class="flex card-actions items-center mt-2 mb-6">
            <button
              id="btnGotScam"
              :disabled="scammer.isActive ? true : false"
              @click="
                scammer.isActive = true;
                ++scammer.count
              "
              :class="
                scammer.isActive
                  ? 'bg-green-400 hover:bg-green-500 text-white py-2 px-4 border-b-4 border-green-500 hover:border-green-500 rounded flex'
                  : 'bg-red-400 hover:bg-red-500 text-white py-2 px-4 border-b-4 border-red-500 hover:border-red-500 rounded flex'
              "
            >
