 ...
 defineEmits(['createNewScammer'])
 const newScammer = ref({}) //////////////เก็บใส่ในนี้
 </script>
...
<div class="bg-white shadow-md rounded-2xl px-6 pt-6 pb-8 mb-4 w-1/2">
 ...
 <div class="flex">
                    <div class="flex-1 text-gray-700 pr-4">
                        ...
                        <input type="text" name="firstName" id="firstName" placeholder="ชื่อ" v-model="newScammer.firstName"
                    ...
                    <div class="flex-1 text-gray-700 pb-3.5">
                        ...
                        <input type="text" name="lastName" id="lastName" placeholder="นามสกุล" v-model="newScammer.lastName"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="shopName" id="shopName" placeholder="ชื่อร้าน" v-model="newScammer.shopName"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>
                <div class="mb-6">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="bank">ธนาคาร</label>
                    <select type="text" name="bank" id="bank" placeholder="ธนาคาร" v-model="newScammer.bank"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        <option>Kbank</option>
                        <option>SCB</option>
                        <option>KTB</option>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="bankId" id="bankId" placeholder="xxxxxxxxxx" v-model="newScammer.bankId"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>
                <div class="mb-6">
                    ...
                    <textarea type="text" name="description" id="description" placeholder="คำอธิบาย..."
                        v-model="newScammer.description"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
      </textarea>
                </div>
